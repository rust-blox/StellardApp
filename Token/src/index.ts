...
export async function initialize<R extends ResponseTypes = undefined>({admin, decimal, name, symbol, account, amount}: {admin: Address, decimal: u32, name: string, symbol: string, account: Address, amount: i128}, options: {
  /**
