...
export declare function initialize<R extends ResponseTypes = undefined>({ dev_acc, launchpad_acc, arty_token, token_admin }: {
    dev_acc: Address;
...
export declare function createCampaign<R extends ResponseTypes = undefined>({ owner_addr, title_cmp, desc_cmp, image_cmp, target_cmp, deadline_cmp }: {
    owner_addr: Address;
    title_cmp: string;
    desc_cmp: string;
    image_cmp: string;
     ...
     */
    secondsToWait?: number;
}): Promise<R extends undefined ? Err<Error_> | Ok<Campaign> : R extends "simulated" ? SorobanClient.SorobanRpc.SimulateTransactionResponse : R extends "full" ? SorobanClient.SorobanRpc.SimulateTransactionResponse | SorobanClient.SorobanRpc.SendTransactionResponse | SorobanClient.SorobanRpc.GetTransactionResponse : Err<Error_> | Ok<Campaign>>;
export declare function getCampaigns<R extends ResponseTypes = undefined>(options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
     */
    fee?: number;
...
export declare function getCampaign<R extends ResponseTypes = undefined>({ campaign_id }: {
    campaign_id: u32;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
...
export declare function donateToCampaign<R extends ResponseTypes = undefined>({ id, donor_address, amount, token_id }: {
    id: u32;
     ...
     */
    secondsToWait?: number;
}): Promise<R extends undefined ? Err<Error_> | Ok<[bigint, bigint, bigint]> : R extends "simulated" ? SorobanClient.SorobanRpc.SimulateTransactionResponse : R extends "full" ? SorobanClient.SorobanRpc.SimulateTransactionResponse | SorobanClient.SorobanRpc.SendTransactionResponse | SorobanClient.SorobanRpc.GetTransactionResponse : Err<Error_> | Ok<[bigint, bigint, bigint]>>;
export declare function getDonators<R extends ResponseTypes = undefined>({ id }: {
    id: u32;
}, options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
     ...
     */
    secondsToWait?: number;
}): Promise<R extends undefined ? Err<Error_> | Ok<string[]> : R extends "simulated" ? SorobanClient.SorobanRpc.SimulateTransactionResponse : R extends "full" ? SorobanClient.SorobanRpc.SimulateTransactionResponse | SorobanClient.SorobanRpc.SendTransactionResponse | SorobanClient.SorobanRpc.GetTransactionResponse : Err<Error_> | Ok<string[]>>;
export declare function getDevAcc<R extends ResponseTypes = undefined>(options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
     */
    fee?: number;
...
export declare function getLaunchpadAcc<R extends ResponseTypes = undefined>(options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
     */
    fee?: number;
...
export declare function getArtyToken<R extends ResponseTypes = undefined>(options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
     */
    fee?: number;
...
export declare function getTokenAdmin<R extends ResponseTypes = undefined>(options?: {
    /**
     * The fee to pay for the transaction. Default: 100.
     */
    fee?: number;
